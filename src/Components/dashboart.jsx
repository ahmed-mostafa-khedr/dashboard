   ...
   useEffect(() => {
    ...
    <div class="col main pt-5 mt-3">
        ...
        <div class="card-columns mb-3">
            <div class="card">
                <img class="card-img-top img-fluid" src={faker.image.technics()} alt="Card image cap"/>
                <div class="card-body">
            ...
            <div class="card">
                <img class="card-img img-fluid" src={faker.image.technics()} alt="Card image"/>
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-lg-6">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" href="#" role="tab" data-toggle="tab">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" role="tab" data-toggle="tab">Profile</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" role="tab" data-toggle="tab">Messages</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" role="tab" data-toggle="tab">Settings</a>
                    </li>
                </ul>
